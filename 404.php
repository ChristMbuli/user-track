...
<body class="bg-gray-100">
    ...
    <div class="bg-gray-200 w-full px-16 md:px-0 h-screen flex items-center justify-center">
        <div
            ...
            <p class="text-2xl md:text-3xl lg:text-5xl font-bold tracking-wider text-gray-500 mt-4">Page non trouvée</p>
            <p class="text-gray-500 mt-4 pb-4 border-b-2 text-center">Désolé, la page que vous recherchez est
                introuvable.
